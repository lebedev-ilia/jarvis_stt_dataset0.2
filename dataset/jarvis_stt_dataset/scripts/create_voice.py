...
def create_voice():
    ...
    audio_dir, metadata = get_path(False, FOLDER_NAMES[0])
    ...
    text = FILENAME.format(BRANCH=BRANCH, FOLDER_NAME=FOLDER_NAME, CNT_VOICE=cnt_voice_str)
